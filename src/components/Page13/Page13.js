	        	...
	        	<p class="larger-font">Which colors do you see in your eyes?</p>
	        	  <div data-toggle="buttons" style={{marginLeft:'20%',marginRight:'20%'}}>
	        		  <label id="q9label1" class="container-with-img" style={{marginLeft:'2%',marginRight:'2%'}}>
	        		    <figure>
	        		    <input type="radio" name="question9" id="q9option1" value="q9a" {...register('q9_response', { required: true })} onclick="buttonClicked();" style={{height:'0'}}/>
	        		    <img class="eyes-pics-style" src={brown_eyes} alt="" srcset=""/>
	        		    <figcaption style={{marginTop:'5px'}}>Goldens, Browns</figcaption></figure>
	        		  </label>
	        		  <label id="q9label2" class="container-with-img" style={{marginLeft:'2%',marginRight:'2%'}}>
	        		  	<figure>
	        		    <input type="radio" name="question9" id="q9option2" value="q9b" {...register('q9_response', { required: true })} onclick="buttonClicked();" style={{height:'0'}}/>
	        		    <img class="eyes-pics-style" src={gray_eyes} alt="" srcset=""/>
	        		    <figcaption style={{marginTop:'5px'}}>Blues, Grays</figcaption></figure>
	        		  </label>
	        		  <label id="q9label3" class="container-with-img" style={{marginLeft:'2%',marginRight:'2%'}}>
	        		  	<figure>
	        		    <input type="radio" name="question9" id="q9option3" value="q9c" {...register('q9_response', { required: true })} onclick="buttonClicked();" style={{height:'0'}}/>
	        		    <img class="eyes-pics-style" src={green_eyes} alt="" srcset=""/>
	        		    <figcaption style={{marginTop:'5px'}}>Green</figcaption></figure>
	        		  </label>
	        		</div>
	        	&nbsp;
	        	{
					errors.q9_response && <div id="q1text" class="responses-div-style">
